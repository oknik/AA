...
public:
	...
	void Emerge()
	{
		...
		//播放怪物出现音效
		AudioEngine::play2d("emerge.ogg", false);
	}
...
public:
	...
	void Dead()
	{
		...
		deadFrames.pushBack(SpriteFrame::create("dead1.png", Rect(0, 0, 128, 128)));
		deadFrames.pushBack(SpriteFrame::create("dead2.png", Rect(0, 0, 128, 128)));
		deadFrames.pushBack(SpriteFrame::create("dead3.png", Rect(0, 0, 128, 128)));
		deadFrames.pushBack(SpriteFrame::create("dead4.png", Rect(0, 0, 128, 128)));
		deadFrames.pushBack(SpriteFrame::create("dead5.png", Rect(0, 0, 128, 128)));
		deadFrames.pushBack(SpriteFrame::create("dead6.png", Rect(0, 0, 128, 128)));
		deadFrames.pushBack(SpriteFrame::create("dead7.png", Rect(0, 0, 128, 128)));
		...
		unschedule("update_monster");
		//播放音效
		AudioEngine::play2d("mon2.ogg", false);
	}
	...
	void Animating()
	{
		...
		animFrames.pushBack(SpriteFrame::create("normal1.png", Rect(0, 0, 68, 61)));
		animFrames.pushBack(SpriteFrame::create("normal2.png", Rect(0, 0, 62, 61)));
