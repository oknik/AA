...
void FirstMapScene::backToMain(cocos2d::Ref* sender) {
    isFirstMapWon = true;
    int selectId = cocos2d::AudioEngine::play2d("Select.mp3", false);//这里的true or false是循环的意思
...
bool FirstMapScene::init() {
    ...
    cocos2d::AudioEngine::stopAll();
    cocos2d::AudioEngine::play2d("PlayBGM.mp3", true);

    auto sprite = cocos2d::Sprite::create("SelectBG.png");
    if (sprite == nullptr)
    {
    ...
    auto path = cocos2d::Sprite::create("Path1.png");
    if (path == nullptr)
    {
    ...
    auto upBoard = cocos2d::Sprite::create("UpBoard.png");
    if (upBoard == nullptr)
    {
    ...
    auto upBoard2 = cocos2d::Sprite::create("UpBoard2.png");
    if (upBoard == nullptr)
    {
    ...
    auto HP = cocos2d::Sprite::create("HP.png");
    ...
    auto hpButton = cocos2d::MenuItemImage::create("Update.png", "Update.png", [=](cocos2d::Ref* sender) {
        if (money >= 500) {
            carrot->hp += 1;
            money -= 500;
            ...
            cocos2d::AudioEngine::play2d("Wrong.mp3", false);
        }
        });
    if (hpButton) {
